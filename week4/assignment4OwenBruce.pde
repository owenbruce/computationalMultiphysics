...
BOUNDARIES       { The domain definition }
  REGION 'wire'       { For each material region }
    ...
    REGION 'res_1'
    sigma = sigRes
    start(Lwx/2+ww/2-0.0015,(Lwy-ww)/2+ww-0.005)
    ...
    REGION 'res_2'
    sigma = sigRes
    start(Lwx+ww/2-0.0015,(Lwy-ww)/2+ww-0.005)
...
report RTheory
report ITheory
report abs(I2-ITheory) as 'Right Current Error'
report abs(I3-ITheory) as 'Left Current Error'
