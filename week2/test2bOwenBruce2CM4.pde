...
rho = 4000
qdot = -k*grad(Temp)
rateheat12 = line_integral(normal(-qdot),'12line')
rateheat23 = line_integral(normal(-qdot),'23line')
...
for t=1
  ...
  vector(qdot) norm
SUMMARY
report val(rateheat12,0,0)
report val(rateheat23,0,0)
